...
}`;var c=(t=>(t[t.Left=0]="Left",t[t.Right=1]="Right",t))(c||{});class w{toString(){return"IntroTask()"}}class x{toString(){return"CalibrateTask()"}}class y{constructor(e){a(this,"id");this.id=e}toString(){return"ShowTask("+this.id+")"}}class k{constructor(e,n,i){a(this,"id");a(this,"left");a(this,"right");a(this,"choice");this.id=e,this.left=n,this.right=i,this.choice=null}choose(e){this.choice=e}toString(){return"ChoiceTask("+this.id+"/"+this.left+" or "+this.id+"/"+this.right+")"}}class g{constructor(e){a(this,"started",!1);a(this,"remaining",3e3);this.remaining=e}start(){this.started=!0;let e=this,n=setInterval(()=>{document.hasFocus()&&(e.remaining-=250)},250);setTimeout(()=>{clearInterval(n)},this.remaining+500)}clear(){this.remaining=0,this.started=!0}get isReady(){return this.remaining<=0}toString(){return"WaitTask("+(this.started?"[counting] ":"[paused] ")+String(this.remaining)+"ms)"}}class S{toString(){return"GoodbyeTask()"}}class _{constructor(e){a(this,"taskIndex",0);a(this,"tasks");a(this,"earlyTermination",!1);const n=e.trials||0,i=(e.algorithms||[]).filter(o=>o.enabled),s=e.images||[];this.tasks=[],this.tasks.push(new w),this.tasks.push(new x);for(const o of Array(n).keys()){const l=T(1,s)[0],[v,u]=T(2,i);this.tasks.push(new y(l)),this.tasks.push(new k(l,v.id,u.id)),o<n-1&&this.tasks.push(new g(e.wait_ms))}this.tasks.push(new S),this.logNextTask()}get currentTask(){return this.tasks[this.taskIndex]}get hasNext(){return this.taskIndex<this.tasks.length-1}get canAdvance(){return this.currentTask instanceof g?(console.log(this.currentTask.remaining),console.log(this.currentTask.started),this.hasNext&&this.currentTask.isReady):this.currentTask instanceof k?this.hasNext&&this.currentTask.choice!=null:this.hasNext}nextTask(){return this.canAdvance?(this.taskIndex+=1,this.logNextTask(),this.currentTask instanceof g&&this.currentTask.start(),!0):!1}terminate(){this.taskIndex=this.tasks.length-1,this.earlyTermination=!0}logNextTask(){console.log("Starting task "+String(this.taskIndex)+"/"+this.tasks.length+": "+this.currentTask.toString())}}function T(t,e){let n=[...Array(e.length).keys()],i=n.length;for(;i!=0;){let o=Math.floor(Math.random()*i);i--,[n[i],n[o]]=[n[o],n[i]]}return n.slice(0,t).map(o=>e[o])}function p(t){if(t==null){console.error("'task' is null");return}t instanceof w&&C(),t instanceof x&&O(),t instanceof y&&z(t),t instanceof k&&K(t),t instanceof g&&P(t),t instanceof S&&B(),N()}function C(t){h().innerHTML=H,d(f())}function O(t){h().innerHTML=q,d(f())}function z(t){h().innerHTML=E,G(t),d(f())}function K(t){h().innerHTML=F,Y(t),d(f())}function P(t){h().innerHTML=W,J(t),d(f())}function B(t){h().innerHTML=A,D(),d(f()),console.log(r)}function G(t){let e=document.querySelector("#show-img");if(e==null){console.error("'img' is null");return}e.src="./public/img/"+t.id+"/base.png"}function Y(t){let e=document.querySelector("#left-img"),n=document.querySelector("#right-img");if(e==null){console.error("'left' is null");return}if(n==null){console.error("'right' is null");return}e.addEventListener("click",i=>{m(c.Left)}),n.addEventListener("click",i=>{m(c.Right)}),e.src="./public/img/"+t.id+"/"+t.left+".png",n.src="./public/img/"+t.id+"/"+t.right+".png"}function m(t){if(!((r==null?void 0:r.currentTask)instanceof k))return;let e=document.querySelector("#left-container"),n=document.querySelector("#right-container");e.classList.remove("unmarked-choice","other-choice","selected-choice"),n.classList.remove("unmarked-choice","other-choice","selected-choice"),t===null&&(e.classList.add("unmarked-choice"),n.classList.add("unmarked-choice")),t===c.Left&&(e.classList.add("selected-choice"),n.classList.add("other-choice")),t===c.Right&&(e.classList.add("other-choice"),n.classList.add("selected-choice")),r.currentTask.choose(t)}function J(t){const e=document.querySelector("#countdown");if(e==null){console.error("'countdown' is null");return}let n=!0;const i=setInterval(()=>{document.hasFocus()&&(t.remaining>0?e.innerText="Please wait "+String(Math.round(t.remaining/100)/10)+" seconds...":(n&&(n=!1,r.nextTask(),p(r.currentTask)),e.innerText="You may continue now."))},50);setTimeout(()=>{clearInterval(i)},t.remaining+500)}function D(t){const e=document.querySelector("#results");if(e==null){console.error("'results' is null");return}e.value=JSON.stringify(r)}function U(t){L()}function L(){if(r==null){console.error("'experiment' is null");return}r.nextTask()&&p(r.currentTask)}function Z(){if(r==null){console.error("'experiment' is null");return}r.terminate(),p(r.currentTask)}function X(t){if(t==null){console.error("'element' is null");return}let e=r==null?void 0:r.tasks.slice(0,(r==null?void 0:r.taskIndex)+1).filter(i=>i instanceof y).length,n=r==null?void 0:r.tasks.filter(i=>i instanceof y).length;t.innerHTML="Next ("+String(e)+"/"+String(n)+")",t.addEventListener("click",U)}function d(t){if(t==null){console.error("'element' is null");return}X(t.querySelector("#next-task"))}function j(t){t==="KeyS"&&L(),t==="KeyA"&&m(c.Left),t==="KeyD"&&m(c.Right),t==="KeyW"&&m(null),t==="Escape"&&Z()}function N(){const t=document.querySelector("#navigation"),n=document.querySelector("#tasks").getElementsByTagName("img"),i=window.innerWidth,s=window.innerHeight-t.offsetHeight+100,o=Math.min(i,s),l=Math.max(i,s),u=Math.min(o,l/2.2)/1e3;for(const b of n)u<1?b.style.maxWidth=String(1e3/Math.pow(2,Math.ceil(Math.log2(1/u))))+"px":b.style.maxWidth=String(1e3*Math.floor(u)/2)+"px";console.log("Resized = ["+i+", "+s+"], Factor = "+u)}function Q(t){j(t.code)}function V(t){N()}function $(t){(r==null?void 0:r.currentTask)instanceof g&&(r==null||r.currentTask.clear(),p(r.currentTask))}let h=()=>document.querySelector("#experiment"),f=()=>document.querySelector("#navigation"),r=new _(JSON.parse(R));document.addEventListener("keyup",Q);window.addEventListener("resize",V);window.addEventListener("focus",$);p((r==null?void 0:r.currentTask)||null);
