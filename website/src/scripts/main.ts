...
import configJson from "../data/configuration.json?raw";
...
function onResize(_: UIEvent): void {
    imageResize();
}

function onFocus(_: FocusEvent): void {
...
let experiment = new Experiment(JSON.parse(configJson) as Configuration)
